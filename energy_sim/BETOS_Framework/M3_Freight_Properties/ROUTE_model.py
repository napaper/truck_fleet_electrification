...
from ..M3_Freight_Properties import M31_CreateTracks
...
def freight_model(env, scenario):
    # Load Freight Cycle
    route_array_speed, route_array_distance, route_array_stoptime, route_array_slope = M31_CreateTracks.get_tracks(scenario)
